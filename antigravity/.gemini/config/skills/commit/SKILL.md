---
name: commit
description: Create a commit following conventional commit guidelines. Use when you need to write or propose a conventional git commit.
---
...
9. Once approved, create the commit using `git commit` (do NOT use -m flag, use a temp file or heredoc for multi-line messages)
